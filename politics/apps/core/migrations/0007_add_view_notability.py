...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'View.notability'
        db.add_column('core_view', 'notability', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'View.notability'
        db.delete_column('core_view', 'notability')
