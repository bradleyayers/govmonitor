...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reference.published_on'
        db.add_column('core_reference', 'published_on', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reference.published_on'
        db.delete_column('core_reference', 'published_on')
