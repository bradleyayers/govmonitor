...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Reference.is_archived'
        db.delete_column('core_reference', 'is_archived')


    def backwards(self, orm):
        
        # Adding field 'Reference.is_archived'
        db.add_column('core_reference', 'is_archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
