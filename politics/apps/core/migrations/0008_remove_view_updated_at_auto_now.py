...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'View.updated_at'
        db.alter_column('core_view', 'updated_at', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'View.updated_at'
        db.alter_column('core_view', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
