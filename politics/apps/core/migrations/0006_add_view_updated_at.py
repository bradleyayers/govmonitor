...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'View.updated_at'
        db.add_column('core_view', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 3, 11, 7, 25, 1, 994513), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'View.updated_at'
        db.delete_column('core_view', 'updated_at')
