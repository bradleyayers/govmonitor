...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'View.slug'
        db.delete_column('core_view', 'slug')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'View.slug'
        raise RuntimeError("Cannot reverse this migration. 'View.slug' and its values cannot be restored.")
