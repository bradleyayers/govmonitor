...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Issue.is_popular'
        db.delete_column('core_issue', 'is_popular')


    def backwards(self, orm):
        
        # Adding field 'Issue.is_popular'
        db.add_column('core_issue', 'is_popular', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
