...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.parent'
        db.add_column('core_party', 'parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['core.Party']), keep_default=False)

        # Adding field 'Party.tree_left'
        db.add_column('core_party', 'tree_left', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Party.tree_right'
        db.add_column('core_party', 'tree_right', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Party.tree_id'
        db.add_column('core_party', 'tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Adding field 'Party.tree_level'
        db.add_column('core_party', 'tree_level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Party.parent'
        db.delete_column('core_party', 'parent_id')

        # Deleting field 'Party.tree_left'
        db.delete_column('core_party', 'tree_left')

        # Deleting field 'Party.tree_right'
        db.delete_column('core_party', 'tree_right')

        # Deleting field 'Party.tree_id'
        db.delete_column('core_party', 'tree_id')

        # Deleting field 'Party.tree_level'
        db.delete_column('core_party', 'tree_level')
